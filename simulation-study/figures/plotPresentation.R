...
legend(6.5,1.075, "True values   ", lty = 2, cex = legend.size, 
       col="black", bty = "n")
...
makePlot(true.vector = mu1$par.values, 
         add.N = TRUE, n.height=0.65, n.center = 2,
         ...
         output.Folders = output.Folders, cex.size = 1.1,
         hor.col1 = legend.col, ylab.cex = ylab.size)
legend(8.2,1.6, "True values   ", lty = 2, cex = legend.size, 
       col="black", bty = "n")
...
makePlot(true.vector = driftLength$par.values, ylab.cex = ylab.size,
         ...
         output.Folders = output.Folders, cex.size = 1.1,
         hor.col1 = legend.col, add.N = TRUE, n.height=0.65, n.center = 1.5)
legend(6.5,3.075, "True values   ", lty = 2, cex = legend.size, 
       col="black", bty = "n")
