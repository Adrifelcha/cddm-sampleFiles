...
```{r}
par(mfrow = c(2,2))
plot.PosteriorDensity(drift,par$driftLength)
plot.PosteriorDensity(bound,par$thresh)
plot.PosteriorDensity(ter0,par$ndt)
plot.PosteriorDensity(theta0,par$driftAngle)
```
...
# Then, compare against point descriptors for posterior samples
##########################################################################
MAPS
means
```